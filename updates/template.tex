...
\begin{enumerate}
    ...
    \item Attempted dealing with my issues on another, more powerful computer, to no avail. But it was fun to use git to easily transport my files over (even though I did have to go through the arduous problem of setting up the SSH key once more).
\end{enumerate}
...
\begin{enumerate}
	...
	\item The OutOfMemory Error doesn't seem to be a computing power thing -- maybe it's something I can troubleshoot, but more than likely, I'm going to have to bite the bullet and narrow things down substantially before playing around with it. Sigh.
\end{enumerate}
...
\begin{enumerate}
	\item Early work this week has been largely reading-based and does not have more than one code commit unfortunately, and that one code commit is to move it to my PC for playing around, which, surprise, didn't work. So yeah, just the one for today. Expect substantial progress next week!
\end{enumerate}
